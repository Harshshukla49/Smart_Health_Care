...
const options = [
  {
    ...
    description: 'Create a patient account to track vitals, updates, and your remote monitoring timeline.',
    icon: UserRound,
    to: '/signup/patient',
  ...
  {
    title: 'Doctor Signup',
    description: 'Create a doctor account to access clinical triage views and real-time patient monitoring.',
    icon: Stethoscope,
    to: '/signup/doctor',
        ...
        <div className="w-full rounded-[2rem] border border-white/12 bg-white/8 p-6 shadow-[0_30px_120px_rgba(2,6,23,0.5)] backdrop-blur-2xl sm:p-8 lg:p-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base leading-8 text-slate-300 md:text-lg">
              Choose your role to set up access. Patients get a personal monitoring view. Doctors get the clinical dashboard.
            </p>
          </div>
